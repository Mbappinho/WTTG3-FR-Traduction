...
|------------|---------------------|--------|
| v1.6.1 | `24415407` | Retrait injecteur AZERTY (fatal errors) ; pak ZQSD seul + doc mini-jeux W/A |
| v1.6.0 | `24415407` | ~~UE4SS/AHK mini-jeux~~ retire en 1.6.1 ; INSTALLER relance apres maj GitHub |
